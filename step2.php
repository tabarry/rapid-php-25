            ...
            <div id="content">
                ...
                <form id="form1" name="form1" method="post" action="step3.php" onsubmit="return validate2();">
                    ...
                    while ($row = mysqli_fetch_array($rs)) {
                        if (($row[0] != 'sulata_settings') && ($row[0] != 'sulata_users') && ($row[0] != 'sulata_faqs') && ($row[0] != 'sulata_headers') && ($row[0] != 'sulata_media_categories') && ($row[0] != 'sulata_media_files') && ($row[0] != 'sulata_pages') && ($row[0] != 'sulata_blank') && ($row[0] != 'sulata_testimonials')) {
                            $chk = 'checked="checked"';
                            $color = '';
                        } else {
                            $chk = '"';
